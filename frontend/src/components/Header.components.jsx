    ...
    <div className='flex flex-col md:flex-row items-center justify-end  bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            <p className='text-3xl md:text-4xl lg:text-5xl text-white font-semibold leading-tight md:leading-tight lg:leading-10'>
                MediConnect <br/><span className='text-xl'>"Connecting Patients with care Seamlessly"</span>
            </p>
        ...
        <div className='md:w-2/5 h-35 flex flex-col items-center rounded-lg relative'>
            ...
            Welcome to MediConnect, your trusted healthcare companion, designed to simplify and enhance the process of connecting patients with healthcare professionals. MediConnect is a cutting-edge platform  ... <button onClick={()=>{navigate(`/about`); scrollTo(0,0)}}className=' text-teal-900 text- rounded-full hover:scale-105 transition all duration-300'>read more</button>
            </p>
        </div>
    </div>
