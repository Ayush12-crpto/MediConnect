...
const MyAppointment = () => {
  ...
  const appointmentRazorpay=async(appointmentId)=>{
    // Mock successful payment for now (bypassing Razorpay)
    toast.success("Payment successful (Bypassed Razorpay)");
    setAppointments(prev => prev.map(item => item._id === appointmentId ? { ...item, payment: true } : item));
