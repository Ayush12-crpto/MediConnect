    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600 '>
          <p>Welcome to MediConnect, your trusted healthcare companion, designed to simplify and enhance the process of connecting patients with healthcare professionals. MediConnect is a cutting-edge platform dedicated to providing seamless access to a wide network of qualified doctors across various specialties. Whether you need a routine checkup, a specialist consultation, or urgent care, MediConnect is here to make healthcare accessible, efficient, and stress-free.</p>
          <p>Our platform empowers users to browse profiles of experienced doctors, view their credentials. With just a few clicks, you can book appointments at your convenience—anytime, anywhere. MediConnect eliminates the hassle of long queues and endless phone calls, ensuring that you get the care you need without delays.</p>
          <b className='text-gray-800'>Our Vision</b>
          <p>MediConnect isn’t just a booking tool; it’s your partner in health management. We prioritize your privacy and security, ensuring your personal information is always protected.At MediConnect, we are committed to building a healthier future by bridging the gap between patients and doctors. Let us help you take the first step toward better health, one appointment at a time.</p>
        </div>
      </div>
