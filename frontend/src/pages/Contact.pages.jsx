    ...
    <div>
      ...
      <div className='my-10 flex flex-col items-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-center md:items-start gap-4'>
          ...
          <p className='text-gray-500 text-center md:text-start'>Allahabad <br />211001</p>
          <p className='text-gray-500 text-center md:text-start'>+91 9999999999 <br />email : xyz@gmail.com</p>
